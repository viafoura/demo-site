...
const zephrRule = async (context) => {
  ...
  const Zephr = build("viafoura-viafoura-demo.cdn.zephr.com");
  ...
  switch (outputValue) {
    ...
    default:
      context.intercept();
      console.error("Zephr decision engine error!");
  }
};
...
export const vfZephr = () => {
  ...
  window.vfQ.push(() => {
    window.vf.actions.addInterceptor(
      "live_comments.load_more",
      async (context) => {
